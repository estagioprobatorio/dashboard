...
export default function AmbienteCursista({ userEmail, records, movimentacoes = [], onNovaMovimentacao }) {
    ...
    <div className="tab-content animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div className="glass-panel" style={{
        ...
        <div>
          ...
          <h1 style={{ fontSize: '1.6rem', fontWeight: 800, fontFamily: 'var(--font-header)' }}>
            Olá, {cursistaRecord.nome_cursista}!
          </h1>
          <p style={{ fontSize: '0.9rem', opacity: 0.9, marginTop: '0.25rem' }}>
            Bem-vindo ao seu ambiente de acompanhamento do Estágio Probatório.
          </p>
        </div>
        ...
        >
          <span>📝</span> Solicitar Remanejamento de Turma
        </button>
      </div>
      ...
      {/* Histórico de Solicitações de Remanejamento */}
      <div className="glass-panel" style={{ padding: '1.25rem' }}>
        ...
        {minhasSolicitacoes.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '2rem', color: 'var(--color-text-muted)', backgroundColor: '#f8fafc', borderRadius: '10px', border: '1px dashed #cbd5e1' }}>
            <p style={{ fontSize: '0.95rem', fontWeight: 600 }}>Você ainda não realizou nenhuma solicitação de remanejamento.</p>
            <button className="btn-primary" onClick={() => setShowModalForm(true)} style={{ marginTop: '0.8rem', padding: '0.5rem 1.2rem', fontSize: '0.85rem' }}>
